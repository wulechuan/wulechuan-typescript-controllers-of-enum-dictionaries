...
export default class Page示范页1 extends Vue {
    ...
    private get 字典界面项之列表_字典甲 (): 范_本应用中一切字典之字典条目之视式[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典诸条目之视式_其列表('字典甲') }
    private get 字典界面项之列表_字典乙 (): 范_本应用中一切字典之字典条目之视式[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典诸条目之视式_其列表('字典乙') }
    private get 字典界面项之列表_字典丙 (): 范_本应用中一切字典之字典条目之视式[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典诸条目之视式_其列表('字典丙') }
    ...
    private 当某表单项之值变动后 (所涉填写项之称谓: string, 新值: string, 所涉字典机: 范_本应用中一切字典机) {
