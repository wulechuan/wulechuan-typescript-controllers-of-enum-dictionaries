...
export default class Page示范页1_常见的双列互通之形式 extends Vue {
    ...
    private get 字典界面项之列表_字典甲 (): 范_本应用中一切字典之数据之界面标准项[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典之数据之界面标准项之列表('字典甲') }
    private get 字典界面项之列表_字典乙 (): 范_本应用中一切字典之数据之界面标准项[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典之数据之界面标准项之列表('字典乙') }
    private get 字典界面项之列表_字典丙 (): 范_本应用中一切字典之数据之界面标准项[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典之数据之界面标准项之列表('字典丙') }
    ...
    private 制作字典群之总机 (): void {
        this.字典总机 = 构建字典群之总机<范_本应用中一切字典之数据原项, 范_本应用中一切字典之数据之界面标准项>({
...

                {
                    ...
                    事件处理程序集: {
                        构建或获取原始数据集: () => {
                            ...
                            if (!Array.isArray(字典乙之数据原项集)) { return Promise.resolve([]) }
