...
const 诸字典之构建配置总集之列表 = [
    {
        该字典之唯一标识: '字典甲',
        诸事之应对: { 构建该字典所有条目之原式: 伪XHR接口_字典甲_获取数据列表 },
    },

    {
        该字典之唯一标识: '字典乙',
        该字典机的调试信息之详尽等级: 2,
        诸事之应对: { 构建该字典所有条目之原式: 伪XHR接口_字典乙_获取数据列表 },
    },

    {
        ...
        诸事之应对: {
            ...
            该字典每次数据重建后 (该字典所属字典群之总机, 该字典机) {
                console.log(消息前缀, 该字典所属字典群之总机.该字典群之称谓, '~', 该字典机.该字典之唯一标识, '数据已重建。')
            },
        },
    },
]
