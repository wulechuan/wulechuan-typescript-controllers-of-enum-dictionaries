...
export type 范_用以构建字典群之总机之配置项集<范_所有字典的原始数据项的共同形态 = any, 范_所有字典的界面标准数据项的共同形态 extends 范_界面标准数据项_最简形态 = 范_界面标准数据项_默认形态> = {
    不应自动初始化?: boolean;
...
export type 范_字典群之总机<范_this = any, 范_所有字典的原始数据项的共同形态 = any, 范_所有字典的界面标准数据项的共同形态 extends 范_界面标准数据项_最简形态 = 范_界面标准数据项_默认形态, > = {
    字典机之集: {
...
export function 构建字典群之总机 <范_this = any, 范_所有字典的原始数据项的共同形态 = any, 范_所有字典的界面标准数据项的共同形态 extends 范_界面标准数据项_最简形态 = 范_界面标准数据项_默认形态>(
    thisObject: 范_this,
    字典群之总机之配置项集?: 范_用以构建字典群之总机之配置项集<范_所有字典的原始数据项的共同形态, 范_所有字典的界面标准数据项的共同形态>
): 范_字典群之总机<范_this, 范_所有字典的原始数据项的共同形态, 范_所有字典的界面标准数据项的共同形态> {
    type 范_字典群之总机之构建配置项集_实用型号 = 范_用以构建字典群之总机之配置项集<范_所有字典的原始数据项的共同形态, 范_所有字典的界面标准数据项的共同形态>;
    type 范_字典群之总机_实用型号 = 范_字典群之总机<范_this, 范_所有字典的原始数据项的共同形态, 范_所有字典的界面标准数据项的共同形态>;
