    ...
    const 该甲: 范_该甲 = {
        ...
        为: {
            作乙 <范_该乙_某 extends 范_某_默认 = 范_该甲_任何乙_某之默认式>(
                ...
                return 甲__作乙并蓄__无This<范_该乙_某>.call(该甲_绑定的This, 该甲, 该乙_构建时的配置集)
            },

            取某乙 <范_该乙_某 extends 范_某_默认 = 范_该甲_任何乙_某之默认式>(
                序号: number
            ): null | 范_乙<范_this, 范_该乙_某> {
                return 甲__取某乙__无This<范_该乙_某>.call(该甲_绑定的This, 该甲, 序号)
            },

            乾于某乙 <范_该乙_某 extends 范_某_默认 = 范_该甲_任何乙_某之默认式>(
                该乙: 范_乙<范_this, 范_该乙_某>
            ): Promise<string> {
                return 甲__乾于某乙__无This<范_该乙_某>.call(该甲_绑定的This, 该甲, 该乙)
            },

            坤于某乙 <范_该乙_某 extends 范_某_默认 = 范_该甲_任何乙_某之默认式>(
                该乙: 范_乙<范_this, 范_该乙_某>
            ): void {
                return 甲__坤于某乙__无This<范_该乙_某>.call(该甲_绑定的This, 该甲, 该乙)
            },
        },
...
): 范_乙<typeof this, 范_该乙_某> {
    type 范_该乙 = 范_乙<typeof this, 范_该乙_某>
    ...
    const 该乙: 范_该乙 = {
        ...
        为: {
            震 (
                ...
                return 乙__震__无This<范_该乙_某>.call(该乙_绑定的This, 该甲, 该乙, 雷)
            },
        },
