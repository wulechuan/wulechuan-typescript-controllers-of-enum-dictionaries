...
此乃吴乐川的《【字典群】之管理工具集》。本工具集用以构建一个所谓【字典群之总机】，以管理一个【字典群】。【字典群】中可容纳多个【字典】。该【字典群】可成批、统一地管理这些【字典】。

并且，本工具集要求诸【字典】各自构造出统一格式的所谓【视式】，以便在界面代码（例如 Vuejs 的模板）中采用。又，构造【视式】之方法因【字典】而异，故须开发者提供。
