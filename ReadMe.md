...
1. #### 术语【标准字典】与【特异字典】
    ...
    在真实的应用中，可能涉及若干个【字典】。其中一些【字典】采用的【条目】之【原式】类同，甚至恰好完全相同，另有一些【字典】其【条目】则采用其它独特的【原式】。
    ...
    不难理解，于以上两类【字典】，将其【原式】转换为【视式】的办法是有区别的。但特定于所有产品之型号之【字典】，它们的转换办法恰好完全相同。既然完全相同，我们将这些字典认定为所谓【标准字典】，之后可以统一处理它们。

    由此，我们定义，**在给定的【字典群】中，若有一组【字典】恰好采用了类同甚至完全一致的【条目】之【原式】，则可认定这些【字典】为所谓【标准字典】。凡不认定为【标准字典】的【字典】，不妨称为【特异字典】。**

    **须知，一个应用中可能构建若干个【字典群】。例如，每个页面一个，或每一群类同的页面共用一个。如何设计和采用【字典群】完全是自由的。但之于任何特定的【字典群】，开发者可以任意认定哪些【字典】是该【字典群】中的所谓【标准字典】，其余是【特异字典】。换句话说，同一应用中，不同【字典群】认定的所谓【标准字典】也可以是各不相同的。**
    ...
    倘若确实如上构建了两个独立的【字典群】，那么这两个【字典群】各自有各自的所谓【标准字典】。
