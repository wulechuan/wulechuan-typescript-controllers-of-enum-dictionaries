...
1. #### 术语【标准字典】
    ...
    在真实的应用中，可能涉及若干个字典。这些字典可能由人为确保其数据特征类同或恰好完全相同。

    例如，某假想应用中有【人员角色】、【甲种产品之所有型号】和【乙种产品之所有型号】三种【字典】。其中，【人员角色】字典的【条目】之【原式】之【范】如下：
    ...
    又，于所有产品之型号之【字典】，其诸【条目】之【原式】之【范】均相同，如下：
    ...
    不难理解，于以上两类【字典】，将其【原式】转换为【视式】的办法是有区别的。但特定于所有产品之型号之【字典】，它们的转换办法恰好完全相同。既然完全相同，我们将这些字典认定为所谓【标准字典】，可以统一处理它们。

    **须知，一个应用中可能构建若干个【字典群】。例如，每个页面一个，或每一群类同的页面共用一个。如何设计和采用【字典群】完全是自由的。但之于任何特定的【字典群】，开发者可以任意认定哪些【字典】是该【字典群】中的所谓【标准字典】，其余是非标准的、独特的【字典】。换句话说，同一应用中，不同【字典群】认定的所谓【标准字典】也可以是各不相同的。**
    ...
    **由此还可以看出，虽然本工具集创造了所谓【标准字典】之概念，但鄙人并没有在【字典机】的【形制要求集】中设计任何真实的字段用以标记或表征该【字典机】之【字典】是否为所谓【标准字典】。一个【字典】是否为所谓【标准字典】，仅“暗中”取决于它是否采用【总机】提供的“默认做法”。**
