...
又，实践中，开发者常常遇到某【字典条目】的【唯一标识】与【呈示称谓】互查的任务。例如，已得到某【条目】之 `id` 、`uuid` 之类的【唯一标识】，须求该【条目】之 `displayName` 之类的字段，亦即求其【呈示称谓】。因此，【字典】不但应保有其一切【条目】（【原式】与【视式】），还应提供一些【条目内容映射表】。所谓【条目内容映射表】，目前共有两种，均为哈希表：
